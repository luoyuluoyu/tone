	...
	<div class="w3layouts">
		<div class="signin-agile">
			...
			<form action="login" method="post">
				<input type="text" name="userName" class="name" id="userName"
					placeholder="用户名" required="" value="${userName}"> <input
					type="password" name="passWord" class="password" placeholder="密码"
					required="" value="${passWord}">
				<ul>
					<li><input type="checkbox" id="brand1" value="1"
						name="remenberPwd" <%=isSaveUserName%>> <label
						for="brand1"><span></span>记住密码</label></li>
				</ul>
				<a href="forgetPwd1.jsp">忘记密码?</a><br>
				<div class="clear"></div>
				<input type="submit" value="登录"> <span style="color: red">${Message}</span>
			</form>
		</div>
		...
		<div class="foot1">
			<span class="foot_content"> <a
				...
				class="text-muted">帮助中心</a> |<span>©1998 - 2017 Tencent

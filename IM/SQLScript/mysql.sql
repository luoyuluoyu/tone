...
CREATE TABLE `counter` (
  ...
  `Countercol` varchar(45) NOT NULL,
...
CREATE TABLE `friends` (
  `id` int(11) NOT NULL,
  `friendAccount` varchar(45) NOT NULL,
  `ownAccount` varchar(45) NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `users` (
  ...
  `onlineStatus` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- Dump completed on 2017-09-01  9:51:35
